...
function App() {
  ...
  const currencyInfo = useCurrencyInfo(from); //where currency = from the currency we want to convert from

  // collecting all the currency options from the currencyInfo object
